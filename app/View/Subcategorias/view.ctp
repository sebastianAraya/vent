...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Subcategoria'), array('action' => 'delete', $subcategoria['Subcategoria']['id']), null, __('Are you sure you want to delete # %s?', $subcategoria['Subcategoria']['id'])); ?> </li>
